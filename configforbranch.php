...
if(isset($_POST['edit-config'])){
    ...
    mysqli_query($link,"UPDATE `configforbranch` SET "
            . "`CName` = '$CName', "
            . "`CValue` = '$CValue', "
            . "`CDetail` = '$CDetail' "
            . "WHERE `id` = '$id'");
...
if(isset($_POST['save-config'])){
    ...
    mysqli_query($link, "INSERT INTO `configforbranch` (`BId`, `CName`, `CValue`, `CDetail`) "
            . "VALUES ('$BId', '$CName','$CValue','$CDetail')");
}
                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                    <header class="panel-heading">                                       
                                        <h2 class="panel-title">คอนฟิกโปรแกรมของสาขานี้</h2>                                        
                                    </header>
            ...
            <div class="col-lg-12">
                <div class="table-responsive">
                                <table class="table table-bordered  table-hover" style="font-family: tahoma">
                                    ...
                                    <tbody>
                                        <?php
                                        $result_config = mysqli_query($link,"SELECT * FROM `configforbranch` WHERE `BId` = '$BId'");
                                        while($config = mysqli_fetch_array($result_config)){
                                        ?>
                                    <form method="post" action="configforbranch.php">
                                        <tr>
                                            <td>
