        ...
        <div class="modal-body">            
            <form class="form-horizontal" role="form" method="post" action="modal_branch.php">
              ...
              <div class="form-group">
                <label class="control-label col-sm-3">รหัสโครงการ</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="BId" value="<?php echo $BId; ?>" <?php echo $ReadOnly; ?>>
                </div>          
              </div>
              <div class="form-group">
